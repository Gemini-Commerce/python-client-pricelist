...
class PricelistCreatePriceListRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "code", "name", "description", "isActive", "isDefault", "currency", "vatIncluded", "deliveredDutyPaid", "segments", "markets", "channels", "type", "isSystem"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PricelistCreatePriceListRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PricelistCreatePriceListRequest from a dict"""
        if obj is None:
            return None
