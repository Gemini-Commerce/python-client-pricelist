...
class PricelistGetPriceListItem(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "grn", "itemGrn", "price", "doubleFormatPrice", "endDatePrice", "basePrice", "doubleFormatBasePrice", "currency", "hasTierPrices", "createdAt", "updatedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PricelistGetPriceListItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PricelistGetPriceListItem from a dict"""
        if obj is None:
            return None
