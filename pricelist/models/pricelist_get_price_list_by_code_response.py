...
class PricelistGetPriceListByCodeResponse(BaseModel):
    """
    ...
    type: Optional[PricelistPriceListType] = PricelistPriceListType.UNKNOWN
    is_system: Optional[StrictBool] = Field(default=None, alias="isSystem")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "grn", "code", "name", "description", "isActive", "isDefault", "currency", "vatIncluded", "deliveredDutyPaid", "segments", "markets", "channels", "createdAt", "updatedAt", "type", "isSystem"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PricelistGetPriceListByCodeResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PricelistGetPriceListByCodeResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else PricelistPriceListType.UNKNOWN,
