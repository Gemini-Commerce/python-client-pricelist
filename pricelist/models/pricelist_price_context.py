...
class PricelistPriceContext(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["currency", "segment", "segments", "market", "channel"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PricelistPriceContext from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PricelistPriceContext from a dict"""
        if obj is None:
            return None
